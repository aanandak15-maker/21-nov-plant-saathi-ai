...
export const MarketplaceView = () => {
  ...
  const loadRecommendations = async () => {
    ...
    try {
      ...
      // Fallback: Don't show error, just show all products
        ...
        <div className="overflow-x-auto scrollbar-hide border-t border-white/10">
          <div className="flex gap-1 px-4 py-2 min-w-max">
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm whitespace-nowrap transition ${selectedCategory === 'all'
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm whitespace-nowrap transition ${selectedCategory === 'fertilizer'
                  ? 'bg-orange-400 text-white'
                  : 'bg-white/10 hover:bg-white/20'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm whitespace-nowrap transition ${selectedCategory === 'fungicide'
                  ? 'bg-orange-400 text-white'
                  : 'bg-white/10 hover:bg-white/20'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm whitespace-nowrap transition ${selectedCategory === 'pesticide'
                  ? 'bg-orange-400 text-white'
                  : 'bg-white/10 hover:bg-white/20'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm whitespace-nowrap transition ${selectedCategory === 'equipment'
                  ? 'bg-orange-400 text-white'
                  : 'bg-white/10 hover:bg-white/20'
                }`}
            >

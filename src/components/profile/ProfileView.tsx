...
const menuItems = [
  ...
  },
  {
    ...
    items: [
      { icon: Sparkles, label: "AI Assistant", description: "Configure AI Assistant" },
            ...
            <Card className="bg-card shadow-soft overflow-hidden">
              {section.items.map((item, idx) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-colors ${idx !== section.items.length - 1 ? "border-b border-border" : ""
                    }`}
                >
